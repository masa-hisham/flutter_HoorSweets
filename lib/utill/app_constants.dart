...
class AppConstants {
  static const String appName = 'حلويات حور';
  static const double appVersion = 7.4;
  static const AppMode appMode = AppMode.release;
  static const String fontFamily = 'ScheherazadeNew-SemiBold';
  static const String baseUrl = 'https://hoorsweets.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.arabicFlag, languageName: 'العربية', countryCode: 'PS', languageCode: 'ar'),
